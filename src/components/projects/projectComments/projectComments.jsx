...
import { Row, Col, Media, Form, Button, OverlayTrigger, Popover } from 'react-bootstrap';
                    ...
                    <Col>
                        ...
                        <Form className="mt-5" onSubmit={(e) => onSubmit(e)}>
                            <Row>
                                ...
                                <Col sm={2}>
                                    {props.loggedIn ?
                                        <Button type="submit" className="btn-block">Post</Button> :
                                ...
                                return <li className="pr-5 pl-2 pb-4" key={`${elem.id}${elem.content}`}>
                                    <Media>
                                        ...
                                        <Media.Body className="bg-my-secondary p-3 rounded ml-2">
                                            ...
                                            <p className="text-muted float-right"><i><small>{elem.created_date.split("-").reverse().join("-")}</small></i></p>
...
const mapDispatchToProps = dispatch => {
    return {
        setProjectComments: (comments) => dispatch({ type: actionType.SET_PROJECT_COMMENTS, comments: comments }),
    };
}
